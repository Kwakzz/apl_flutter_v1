...
import 'package:apl/requests/assist/get_season_comp_top_assist_providers_req.dart';
...
class WomensTopAssistProviders extends StatefulWidget {
  const WomensTopAssistProviders(
    {
      super.key,
  ...
  @override
  _WomensTopAssistProvidersState createState() => _WomensTopAssistProvidersState();
}

class _WomensTopAssistProvidersState extends State<WomensTopAssistProviders> {

  List<Map<String, dynamic>> seasonsMap = [];

  List<Map<String, dynamic>> compsMap = [];

  List<Map<String, dynamic>> topAssistProviders = [];
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        topAssistProvidersTable(topAssistProviders: topAssistProviders)
