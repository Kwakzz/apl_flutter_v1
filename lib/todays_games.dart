    ...
    SizedBox fixtures = SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          String startTimeString = fixture['start_time'];
          ...
          // if the start time is greater than the current time, then the game has not started yet so display FixturesGraphicListTile.
          if (startTime.hour > DateTime.now().hour || (startTime.hour == DateTime.now().hour && startTime.minute > DateTime.now().minute)) {
          ...
          // otherwise display ResultsGraphicListTile
          else {
            try {
