...
import '../../requests/players/get_mens_players_req.dart';
import '../../requests/positions/get_positions_req.dart';
import '../../helper_classes/search_field.dart';
import '../../requests/teams/get_mens_teams_req.dart';
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                // this is used to display the teams in the transfer dialogue box
