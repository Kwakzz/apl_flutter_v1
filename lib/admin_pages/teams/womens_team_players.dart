...
class WomensTeamPlayers extends StatefulWidget {
  const WomensTeamPlayers(
    {
      super.key,
      required this.team,
    }
  ...
  @override
  _WomensTeamPlayersState createState() => _WomensTeamPlayersState();
}

class _WomensTeamPlayersState extends State<WomensTeamPlayers> {
    ...
    MyDropdownFormField playerCriteriaDropDown = MyDropdownFormField(
      ...
      onChanged: (newValue) {
        ...
        setState(() {
          ...
          if (newValue == "Retired") {
            getRetiredWomensTeamPlayers(widget.team['team_id']).then((result) {
              setState(() {
                teamPlayers = result;
                filteredTeamPlayers = teamPlayers;
              });
