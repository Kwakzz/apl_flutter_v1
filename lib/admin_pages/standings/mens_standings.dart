...
import '../../requests/competitions/get_mens_comps_req.dart';
import '../../requests/standings/delete_standings_req.dart';



class MensStandings extends StatefulWidget {
  const MensStandings({super.key});

  @override
  _MensStandingsState createState() => _MensStandingsState();
}

class _MensStandingsState extends State<MensStandings> {
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return AdminListTileWithOnTap(
                  title: '${standing['competition_name']} (${standing['standings_name']})',
