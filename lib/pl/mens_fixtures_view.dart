...
class MensFixturesView extends StatefulWidget {
  const MensFixturesView(
    {
      super.key,
  ...
  @override
  _MensFixturesViewState createState() => _MensFixturesViewState();
}

class _MensFixturesViewState extends State<MensFixturesView> {
