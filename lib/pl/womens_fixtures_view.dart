...
class WomensFixturesView extends StatefulWidget {
  const WomensFixturesView(
    {
      super.key,
  ...
  @override
  _WomensFixturesViewState createState() => _WomensFixturesViewState();
}

class _WomensFixturesViewState extends State<WomensFixturesView> {
    ...
    getWomensCompetitions().then((result) {
      ...
      getSeasonCompFixtures(selectedSeasonMap['season_id'], selectedCompMap['competition_id']).then((result) {
        setState(() {
          ...
          compFixtures.removeWhere((fixture) => DateTime.parse(fixture['gameweek_date']).isBefore(DateTime.now()));
