...
class WomensResultsView extends StatefulWidget {
  const WomensResultsView(
    {
      super.key,
  ...
  @override
  _WomensResultsViewState createState() => _WomensResultsViewState();
}

class _WomensResultsViewState extends State<WomensResultsView> {
